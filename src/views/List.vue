...
<template>
  <div class="list">
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item label="活动区域">
        <el-select v-model="formInline.region" placeholder="活动区域">
          <el-option v-for="item in formInline.selectOp" :key="item.id" size="small" :label="item.name" :value="item.id"></el-option>
    ...
    <el-table :data="paginationData.tableList" style="width: 100%" height="500" border :default-sort = "{prop: 'date', order: 'descending'}">
...
<style>
  ...
  .list .el-table td,.list .el-table th{
    padding: 0px;
  }
  .list .el-table .cell{
    line-height: 30px;
  ...
  .list .el-table--border td,.list .el-table--border th,.list .el-table__body-wrapper .el-table--border.is-scrolling-left~.el-table__fixed{
    border-color:#e6e6e6;
  }
  .list .el-table thead{
    color: #666
